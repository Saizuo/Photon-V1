...
# LOL TOKEN GO BRR
BOT_TOKEN = "Nzk0OTQ0MTI4NjYwMTQ0MTQ5.X_CLaQ.rgvZEgAFoAI4ecbrv4PPtwSiGuQ"
MONGO_DB_URL = "mongodb+srv://Saizuo:Claudespeed@epicbot-v2.kqszr.mongodb.net/myFirstDatabase?retryWrites=true&w=majority"
DB_UPDATE_INTERVAL = 60
PREFIX = "p!"
OWNERS = [532177714203852800]
...
UD_API_KEY = os.environ.get("069aade58amsh3797dccb68f6770p167cdfjsn49b775a99f9b")
WEATHER_API_KEY = os.environ.get("")
TOP_GG_TOKEN = os.environ.get("")
TWITCH_CLIENT_ID = os.environ.get("")
TWITCH_CLIENT_SECRET = os.environ.get("")
CHAT_BID = os.environ.get("")
CHAT_API_KEY = os.environ.get("")
DAGPI_KEY = os.environ.get("")
STATCORD_KEY = os.environ.get("")

# SECRET LOGS HEHE :3

ONLINE_LOG_CHANNEL = 880637917956026430
SHARD_LOG_CHANNEL = 880637948293443604
ADD_REMOVE_LOG_CHANNEL = 880637990165159958
DATABASE_LOG_CHANNEL = 880638035673382932
COMMANDS_LOG_CHANNEL = 880638072696500224
ERROR_LOG_CHANNEL = 880638112076816425
DM_LOG_CHANNEL = 880638144301645874
BUG_REPORT_CHANNEL = 880638167655526430
RANK_CARD_SUBMIT_CHANNEL = 880638215936172104
SUGGESTION_CHANNEL = 880638251424165950
USER_REPORT_CHANNEL = 880638300401053696
# COLORS

# MAIN_COLOR = 0xDC143C # crimson
MAIN_COLOR =  0xffffff  # light blue kinda
RED_COLOR =  0xffffff
ORANGE_COLOR =  0xffffff
PINK_COLOR =  0xffffff
PINK_COLOR_2 =  0xffffff
...
INVITE_BOT_LINK = "https://discord.com/api/oauth2/authorize?client_id=794944128660144149&permissions=8&scope=bot"
